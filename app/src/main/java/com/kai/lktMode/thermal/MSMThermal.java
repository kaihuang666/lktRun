...
public class MSMThermal {
    ...
    public void setShutdownTemp(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_SHUTDOWN_TEMP,String.valueOf(value)));
    }
    ...
    public void setCheckIntervalMs(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_CHECK_INTERVAL_MS,String.valueOf(value)));
    }
    ...
    public void setAllowedMaxFreq(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_ALLOWED_MAX_FREQ,String.valueOf(value)));
    }
    ...
    public void setAllowedMaxHigh(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_ALLOWED_MAX_HIGH,String.valueOf(value)));
    }
    ...
    public void setAllowedMaxLow(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_ALLOWED_MAX_LOW,String.valueOf(value)));
    }
    ...
    public void setAllowedMidFreq(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_ALLOWED_MID_FREQ,String.valueOf(value)));
    }
    ...
    public void setAllowedMidHigh(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_ALLOWED_MID_HIGH,String.valueOf(value)));
    }
    ...
    public void setAllowedMidLow(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_ALLOWED_MID_LOW,String.valueOf(value)));
    }
    ...
    public void setAllowedLowFreq(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_ALLOWED_LOW_FREQ,String.valueOf(value)));
    }
    ...
    public void setAllowedLowHigh(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_ALLOWED_LOW_HIGH,String.valueOf(value)));
    }
    ...
    public void setAllowedLowLow(int value) {
        RootUtils.runCommand(ShellUtil.modify(CONF_ALLOWED_LOW_LOW,String.valueOf(value)));
    }
    ...
    public void setMinFreqIndex(int value) {
        RootUtils.runCommand(ShellUtil.modify(MSM_THERMAL_MIN_FREQ_INDEX,String.valueOf(value)));
    }
    ...
    public void enableFreqLimitDebug(boolean enable) {
        RootUtils.runCommand(ShellUtil.modify(MSM_THERMAL_FREQ_LIMIT_DEBUG,enable ? "'1'" : "'0'"));
    }
    ...
    public void setTempLimit(int value) {
        RootUtils.runCommand(ShellUtil.modify(TEMP_LIMIT,String.valueOf(value * mTempLimitOffset.get(TEMP_LIMIT))));
    }
    ...
    public void enableTempThrottle(boolean enable) {
        RootUtils.runCommand(ShellUtil.modify(MSM_THERMAL_TEMP_THROTTLE,enable ? "'Y'" : "'N'"));
    }
    ...
    public void enableTempSafety(boolean enable) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_TEMP_SAFETY),enable ? "'1'" : "'0'"));
    }
    ...
    public void setThermalLimitHigh(int value) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_THERMAL_LIMIT_HIGH),String.valueOf(value)));
    }
    ...
    public void setThermalLimitLow(int value) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_THERMAL_LIMIT_LOW),String.valueOf(value)));
    }
    ...
    public void setTempHysteresisDegC(int value) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_TEMP_HYSTERESIS_DEGC),String.valueOf(value)));
    }
    ...
    public void setPollMs(int value) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_POLL_MS),String.valueOf(value)));
    }
    ...
    public void enableImmediatelyLimitStop(boolean enable) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_POLL_MS),enable ? "'Y'" : "'N'"));
    }
    ...
    public void setFreqStep(int value) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_FREQ_STEP),String.valueOf(value)));
    }
    ...
    public void setCoreTempHysteresisDegC(int value) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_CORE_TEMP_HYSTERESIS_DEGC),String.valueOf(value)));
    }
    ...
    public void setCoreLimitTempDegC(int value) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_CORE_LIMIT_TEMP_DEGC),String.valueOf(value)));
    }
    ...
    public void setLimitTempDegC(int value) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_LIMIT_TEMP_DEGC),String.valueOf(value)));
    }
    ...
    public void enableVddRestriction(boolean enable) {
        RootUtils.runCommand(ShellUtil.modify(getParent(VDD_RESTRICTION_ENABLED),enable ? "'1'" : "'0'"));
    }
    ...
    public void enableCoreControl(boolean enable) {
        RootUtils.runCommand(ShellUtil.modify(CORE_CONTROL,enable ? "'1'" : "'0'"));
    }
    ...
    public void enableThermalDebugMode(boolean enable) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_THERMAL_DEBUG_MODE),enable ? "'1'" : "'0'"));
    }
    ...
    public void enableIntelliThermalOptimized(boolean enable) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_INTELLI_ENABLED),enable ? "'Y'" : "'N'"));
    }
    ...
    public void enableIntelliThermal(boolean enable) {
        RootUtils.runCommand(ShellUtil.modify(getParent(PARAMETERS_ENABLED),enable ? "'Y'" : "'N'"));
    }
