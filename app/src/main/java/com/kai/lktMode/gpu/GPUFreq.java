...
public class GPUFreq {
    ...
    public String setGovernor(String value) {
        return ShellUtil.modify(GOVERNOR,value);
    ...
    public String setMinFreq(int value) {
        return ShellUtil.modify(MIN_FREQ,String.valueOf(value));
    ...
    public int getMinFreq() {
        return Utils.strToInt(Utils.readFile(MIN_FREQ))/MIN_FREQ_OFFSET;
    }
    public int getMinFreqOri() {
    ...
    public String setMaxFreq(int value) {
        return ShellUtil.modify(MAX_FREQ,String.valueOf(value));
    ...
    public int getMaxFreq() {
        return Utils.strToInt(Utils.readFile(MAX_FREQ))/MAX_FREQ_OFFSET;
    }
    public int getMaxFreqOri() {
    ...
    public List<String> getAdjustedFreqs() {
        List<String> list = new ArrayList<>();
        for (int freq : getAvailableFreqs()) {
            list.add((freq / AVAILABLE_GOVERNORS_OFFSET) + "MHz");
        }
        return list;
    }
    ...
    public int getAVAILABLE_GOVERNORS_OFFSET() {
        return AVAILABLE_GOVERNORS_OFFSET;
    }
